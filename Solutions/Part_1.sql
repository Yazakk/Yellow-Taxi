...
FROM "NYC_Yellow_Taxi_Trip_20204_01"
WHERE payment_type IN (1, 2, 5)
  AND tpep_dropoff_datetime BETWEEN 
      (SELECT MAX(tpep_dropoff_datetime) - INTERVAL '30 days' FROM "NYC_Yellow_Taxi_Trip_20204_01")
      AND (SELECT MAX(tpep_dropoff_datetime) FROM "NYC_Yellow_Taxi_Trip_20204_01");
...
FROM "public"."NYC_Yellow_Taxi_Trip_20204_01"
WHERE payment_type IN (1, 2, 5)
  AND tpep_dropoff_datetime BETWEEN 
      (SELECT MAX(tpep_dropoff_datetime) - INTERVAL '30 days' FROM "public"."NYC_Yellow_Taxi_Trip_20204_01")
      AND (SELECT MAX(tpep_dropoff_datetime) FROM "public"."NYC_Yellow_Taxi_Trip_20204_01")
